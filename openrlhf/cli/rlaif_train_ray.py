...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_gpus_per_policy_actor", type=int, default=0, help="Number of GPUs each policy actor.")
    parser.add_argument("--num_gpus_per_labeler_actor", type=int, default=0, help="Number of GPUs each labeler actor.")
    parser.add_argument("--num_gpus_per_ref_actor", type=int, default=0, help="Number of GPUs each ref actor.")
